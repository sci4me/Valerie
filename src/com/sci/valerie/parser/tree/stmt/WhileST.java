...
public final class WhileST extends StatementST {
    public final FunctionST function;
    public final ExpressionST condition;
    public final StatementST code;

    public WhileST(final Scope scope, final FunctionST function, final ExpressionST condition, final StatementST code) {
        super(scope);
